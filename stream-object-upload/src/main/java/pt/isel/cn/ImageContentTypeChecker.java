...
public class ImageContentTypeChecker {
    ...
    /**
     * Returns the content type of the image or null if the image format is not supported.
     * @param imageData the image data in bytes
     * @return the content type of the image or null if the image format is not supported
     */
